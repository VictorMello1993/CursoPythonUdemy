...
#Versão de execução no terminal
...
"""Testando se o código está no módulo principal para que
execute no terminal. Não é possível executar pelo 
Code Runner, pois fica somente leitura"""
